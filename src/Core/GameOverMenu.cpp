...
GameOverMenu::GameOverMenu()
{
    ...
    m_titleText.setPosition(windowWidth / 2.f, 100.f);
    ...
    m_continueText.setPosition(windowWidth / 2.f, 500.f);
}
...
void GameOverMenu::setResults(float distance, int coins)
{
    ...
    m_distanceText.setPosition(windowWidth / 2.f, 200.f);
    ...
    m_coinsText.setPosition(windowWidth / 2.f, 250.f);
    ...
    m_scoreText.setPosition(windowWidth / 2.f, 300.f);
}
